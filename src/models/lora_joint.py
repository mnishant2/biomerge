...
class LoRAJointModel(nn.Module):
    """LoRA model for joint NER and EL decoding using generative approach.
    
    This model is trained to generate text with markdown annotations [entity](CUI)
    which jointly handles both NER (entity spans) and EL (entity linking).
    """
...
def build_lora_joint_model(**kwargs):
    """Factory function to build a LoRA joint model with specified parameters."""
    return LoRAJointModel(**kwargs) 