...
class JointDecodeModule(BaseDataModule):
    """Data module for joint decoding with generative approach."""

    def __init__(
        self,
        path: str = "data/union/joint_decode_EL",
        ...
        """Initialize the Joint Decode datamodule.
        ...
        logger.info(f"Initializing JointDecode DataModule with {tokenizer_name}")
    ...
    def _tokenize_function(self, examples, max_length=256):
        """Tokenize inputs and targets for generative joint decoding."""
        # Tokenize inputs
